<div class="container">
    ...
    <div class="card mt-3 text-white" style="background-color: rgba(25, 25, 25, 0.645); -webkit-backdrop-filter: blur(15px); backdrop-filter: blur(15px);">
        ...
        <div class="card-body mb-4" style="display: flex; place-content: center">
                    ...
                    <div class="d-flex justify-content-center" style="width: 1500px">
                        ...
                        <div class="card-left w-50 text-white float-right p-5" style="margin-top: -40px; border-radius:20px; width: 700px; background-color: rgb(18, 18, 18)">
                            ...
                            <form wire:submit.prevent='editUsername'>
                                ...
                                <div class="d-flex">
                                    ...
                                    @if ($username !== auth()->user()->username)
                                      <button type="submit" class="btn btn-outline-light border-1 border-secondary " style="width: 150px; height: 40px;">Click Save!</button>
                                    @else
                                      <button type="submit" class="btn btn-outline-light border-1 border-secondary " style="width: 150px; height: 40px;" disabled>Click Save!</button>
                                    @endif
                                  </div>
                            ...
                            @error('current_password') <div class="invalid-feedback">{{ $message }}</div> @enderror <br> <br>

                            <label for="newpassword">New Password</label>
                            <input type="password" name="newpassword" id="newpassword" style="background-color: rgb(52, 52, 52)" class="form-control border-0 text-white p-2 mb-2" wire:model.defer="password">
                            @error('password')
                            ...
                            <button type="submit" class="btn btn-outline-light border-1 border-secondary p-3"> <i class="fa-solid fa-floppy-disk"></i> Update </button>
