    ...
    @endif
       <div class="card-body">
            ...
            <div style="margin-top: -670px;">
                ...
                <div class="right" style="margin-left: 600px; margin-top: -705px;">
    ...
    <div class="modal-dialog" style="max-width: 1000px;">
      <div class="modal-content"  style="background-color: rgba(25, 25, 25, 0.645); -webkit-backdrop-filter: blur(15px); backdrop-filter: blur(15px);">
              ...
              @if ($musicbar->id === $selectedMusicBarId)
                ...
                <div class="d-flex justify-content-between text-white rounded shadow mb-3" style="background-color: rgba(19, 19, 19, 0.887)">
                  @if ($musicbar->id === $selectedMusicBarId)
                    ...
                    <h6 class="text-white mt-3 p-3">💸 Total Transactions: {{ $musicbar->bookings->whereIn('status', ['Completed', 'Pending'])->count() }}</h6>
                  @endif
                </div>
              @endif
            @endforeach
        ...
        @endif
          ...
          <div class="buttonView float-end" style="margin-top: -50px">
            <button type="button" class="btn btn-outline-light border-1 border-secondary p-3" data-bs-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
          </div>
