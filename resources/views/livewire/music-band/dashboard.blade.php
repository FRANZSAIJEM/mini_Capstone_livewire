<div class="p-5" style="margin-top: -50px;">
    ...
    <div style="margin-top: 125px" wire:ignore.self class="modal fade text-white" id="view" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
