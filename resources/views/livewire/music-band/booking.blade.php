                    ...
                    <div class="d-flex justify-content-between w-100">
                        ...
                        <div class="card-left d-block rounded p-5" style="width: 700px; background-color: rgb(18, 18, 18)">
                            ...
                            <form wire:submit.prevent="sendRequest">
                                ...
                                <textarea name="" id="" cols="30" rows="10" style="background-color: rgb(52, 52, 52); width: 600px; height: 75px;" class="form-control border-0 text-white p-2 mb-2" wire:model='eventdescription'></textarea>
